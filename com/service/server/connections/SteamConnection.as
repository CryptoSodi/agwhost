package com.service.server.connections
{
	...
	public class SteamConnection extends Connection
	{
		...
		override public function connect():void
		{
			...
			var loginUri:String        = ExternalInterfaceAPI.getLoginProtocol() + "://" + ExternalInterfaceAPI.getLoginHostname() + ':' + ExternalInterfaceAPI.getLoginPort() + "/login/steam";
			...
			ExternalInterfaceAPI.logConsole("Imeprium Ticket = " + ExternalInterfaceAPI.getSteamSessionTicket());
