...
package org.zlibfromscratch
{
	...
	public class ZlibDecoder
	{
		...
		private var _adler32:Adler32;
		private var _crc32:CRC32;

		// KABAM CHANGE BEGIN - Allow headerless streams. -bmazza 6/10/13
		private var _has_header_and_trailer:Boolean;
		// KABAM CHANGE END
		...
		private var _dictionary:CircularByteArray            = new CircularByteArray();
		// KABAM CHANGE END
		 ...
		 */
		// KABAM CHANGE BEGIN - Allow headerless streams. -bmazza 6/10/13
		public function reset( verifyChecksum:Boolean = false, includesZlibHeaderAndTrailer:Boolean = true ):void
		// KABAM CHANGE END
		{
			// KABAM CHANGE BEGIN - Allow headerless streams. -bmazza 6/10/13
		...
		public function feed( input:ByteArray, output:ByteArray ):uint
		{
			...
			const more:uint = ZlibDecoderError.NEED_MORE_DATA;
