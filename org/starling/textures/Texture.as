...
package org.starling.textures
{
	...
	public class Texture
	{
		...
		public static function fromBitmapData( data:BitmapData, generateMipMaps:Boolean = true,
											   optimizeForRenderToTexture:Boolean = false,
											   scale:Number = 1, format:String = Context3DTextureFormat.BGRA ):Texture
		{
			...
			var nativeTexture:flash.display3D.textures.Texture = context.createTexture(
				legalWidth, legalHeight, format, optimizeForRenderToTexture);
			...
			var concreteTexture:ConcreteTexture                = new ConcreteTexture(
				nativeTexture, format, legalWidth, legalHeight,
