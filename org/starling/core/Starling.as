...
package org.starling.core
{
	...
	import org.starling.display.Stage;
	import org.starling.events.EventDispatcher;
	import org.starling.events.ResizeEvent;
	...
	public class Starling extends EventDispatcher
	{
		...
		private function initializeGraphicsAPI():void
		{
			...
			dispatchEventWith(org.starling.events.Event.CONTEXT3D_CREATE, false, mContext);
		}
		...
		private function initializeRoot():void
		{
			if (mRoot == null)
			{
				...
				dispatchEventWith(org.starling.events.Event.ROOT_CREATED, false, mRoot);
			}
		}
		...
		/** Dispatches ENTER_FRAME events on the display list and processes touches. */
		...
		private function onKey( event:KeyboardEvent ):void
		{
			...
			makeCurrent();
			mStage.dispatchEvent(new org.starling.events.KeyboardEvent(
		...
		public function showStatsAt( hAlign:String = "left", vAlign:String = "top", scale:Number = 1 ):void
		{
			if (mContext == null)
			{
				...
				addEventListener(org.starling.events.Event.ROOT_CREATED, onRootCreated);
			} else
			{
			...
			function onRootCreated():void
			{
				...
				removeEventListener(org.starling.events.Event.ROOT_CREATED, onRootCreated);
			}
		}
