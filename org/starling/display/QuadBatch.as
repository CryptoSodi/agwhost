...
package org.starling.display
{
	...
	import org.starling.core.RenderSupport;
	import org.starling.core.Starling;
	import org.starling.core.starling_internal;
	import org.starling.errors.MissingContextError;
	import org.starling.events.Event;
	import org.starling.filters.FragmentFilter;
	import org.starling.filters.FragmentFilterMode;
	import org.starling.textures.Texture;
	import org.starling.textures.TextureSmoothing;
	import org.starling.utils.MatrixUtil;
	import org.starling.utils.VertexData;
	...
	public class QuadBatch extends DisplayObject
	{
									  ...
									  blendMode:String = null ):void
		{
			...
			var programName:String = mTexture ?
				getImageProgramName(tinted, false, false, mTexture.format, mSmoothing) :
				QUAD_PROGRAM_NAME;
									   ...
									   smoothing:String, blendMode:String, numQuads:int = 1 ):Boolean
		{
			if (mNumQuads == 0)
				return false;
			else if (mNumQuads + numQuads > 8192)
