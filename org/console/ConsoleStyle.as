...
package org.console {
	...
	public class ConsoleStyle {
		...
		public function updateStyleSheet():void {
			...
			menuFont = ExternalInterfaceAPI.getMainFont();
			ExternalInterfaceAPI.logConsole("Set Main font: " + menuFont);
			traceFont = ExternalInterfaceAPI.getTraceFont();
			ExternalInterfaceAPI.logConsole("Set Trace font: " + traceFont);
