...
package org.console
{
	 ...
	 * It is a singleton controller for <code>Console (org.junkbyte.console.Console)</code>.
	 * <p>
	...
	public class Cc
	{
		 ...
		 * @see org.junkbyte.console.ConsoleConfig
		 */
		...
		public static function startOnStage( display:DisplayObject, password:String = "" ):void
		{
			if (_console)
			{
				if (display && display.stage && _console.parent != display.stage)
		...
		{
			if (_console)
				_console.addCh(channel, strings, Console.LOG);
		}
		/**
		...
		{
			if (_console)
				_console.addCh(channel, strings, Console.INFO);
		}
		/**
		...
		{
			if (_console)
				_console.addCh(channel, strings, Console.DEBUG);
		}
		/**
		...
		{
			if (_console)
				_console.addCh(channel, strings, Console.WARN);
		}
		/**
		...
		{
			if (_console)
				_console.addCh(channel, strings, Console.ERROR);
		}
		/**
		...
		{
			if (_console)
				_console.addCh(channel, strings, Console.FATAL);
		}
		/**
