...
{
	import org.console.ConsoleStyle;
	import org.console.ConsoleConfig;
	...
	public class ConsolePanel extends Sprite
	{
		...
		private function onScalerMouseDown( e:Event ):void
		{
			...
			_snaps = [[], []];
			scaler.addEventListener(MouseEvent.MOUSE_UP, onScalerMouseUp, false, 0, true);
		...
		{
			scaler.removeEventListener(MouseEvent.MOUSE_UP, onScalerMouseUp);
