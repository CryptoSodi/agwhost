...
package org.console
{
	...
	import org.console.core.CommandLine;
	import org.console.core.ConsoleTools;
	import org.console.core.Graphing;
	import org.console.core.KeyBinder;
	import org.console.core.LogReferences;
	import org.console.core.Logs;
	import org.console.core.MemoryMonitor;
	import org.console.core.Remoting;
	import org.console.view.PanelsManager;
	import org.console.view.RollerPanel;
	import org.console.vos.Log;
	 ...
	 * Please see org.junkbyte.console.Cc for documentation as it shares the same properties and methods structure.
	 * @see http://code.google.com/p/flash-console/
	 * @see org.junkbyte.console.Cc
	 */
	public class Console extends Sprite
	{
		 ...
		 * See org.junkbyte.console.Cc for documentation as it shares the same properties and methods structure.
		 *
		 * @see org.junkbyte.console.Cc
		 * @see http://code.google.com/p/flash-console/
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#listenUncaughtErrors()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#addGraph()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#fixGraphRange()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#removeGraph()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#bindKey()
		 */
		public function bindKey( key:KeyBind, callback:Function, args:Array = null ):void
		{
			if (key)
				_kb.bindKey(key, callback, args);
		}

		/**
		 * @copy org.junkbyte.console.Cc#addMenu()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#displayRoller
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#setRollerCaptureKey()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#fpsMonitor
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#memoryMonitor
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#watch()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#unwatch()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#store()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#map()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#mapch()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#inspect()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#inspectch()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#explode()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#explodech()
		 */
		...
		private function _onEnterFrame( e:Event ):void
		{
			...
			if (visible && parent)
			{
				...
				if (graphsList)
					_panels.updateGraphs(graphsList);
			}
		}
		//
		// REMOTING
		...
		/**
		 * @copy org.junkbyte.console.Cc#remoting
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#remotingSocket()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#setViewingChannels()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#setIgnoredChannels()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#minimumPriority
		 */
		...
		public function addLine( strings:Array, priority:int = 0, channel:* = null, isRepeating:Boolean = false, html:Boolean = false, stacks:int = -1 ):void
		{
			...
			if (priority >= _config.autoStackPriority && stacks < 0)
				stacks = _config.defaultStackDepth;
		...
		/**
		 * @copy org.junkbyte.console.Cc#commandLine
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#addSlashCommand()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#add()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#stack()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#stackch()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#log()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#info()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#debug()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#warn()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#error()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#fatal()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#ch()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#logch()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#infoch()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#debugch()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#warnch()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#errorch()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#fatalch()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#addCh()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#addHTML()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#addHTMLch()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#clear()
		 */
		public function clear( channel:String = null ):void
		{
			_logs.clear(channel);
			if (!_paused)
				_panels.mainPanel.updateToBottom();
			_panels.updateMenu();
		}

		/**
		 * @copy org.junkbyte.console.Cc#getAllLog()
		 */
		...
		/**
		 * @copy org.junkbyte.console.Cc#config
		 */
