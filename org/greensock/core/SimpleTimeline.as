...
package org.greensock.core
{
	...
	public class SimpleTimeline extends TweenCore
	{
		...
		public function SimpleTimeline( vars:Object = null, manual:Boolean = false )
		{
			super(0, vars);
		}
		...
		public function insert( tween:TweenCore, time:* = 0 ):TweenCore
		{
			...
			{ //we only adjust the cachedPauseTime if it wasn't in this timeline already. Remember, sometimes a tween will be inserted again into the same timeline when its startTime is changed so that the tweens in the TimelineLite/Max are re-ordered properly in the linked list (so everything renders in the proper order). 
